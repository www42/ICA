...
wget https://eu-central-1-tcprod.s3.eu-central-1.amazonaws.com/courses/ILT-TF-200-ARCHIT/v7.1.8/lab-4-HA/scripts/inventory-app.zip
...
un="dbadmin"
pw="lab-password"
ep="inventory-cluster.cluster-c338vin0vvxe.eu-central-1.rds.amazonaws.com"
db="inventory"
